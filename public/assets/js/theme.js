...
(function ($) {
	...
	if ($("body").hasClass("tt-transition")) {
		...
		function HideLoad() {
			...
			tl_transitOut.from("#page-content", { duration: 0.5, autoAlpha: 0, y: 80, ease: Expo.easeOut, clearProps: "all" }, 0.8);
			tl_transitOut.set("#page-transition", { duration: 0.5, autoAlpha: 0, ease: Expo.easeInOut });
		}
	...
	$(".lightgallery").lightGallery({
		...
		pause: 1000, // The time (in ms) between each auto transition.
		progressBar: true, // Enable autoplay progress bar.
		fourceAutoplay: true, // If false autoplay will be stopped after first user action
